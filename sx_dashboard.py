...
# 탭 구성
# =============================================================================
tab1, tab2, tab3, tab4, tab5 = st.tabs(["📊 시뮬레이션 결과", "📐 모델 수식", "📈 pH Isotherm", "🔬 추출제 비교", "📋 상세 데이터"])
...
# =============================================================================
st.markdown("---")
st.caption("⚗️ SX Simulator v1.0 | MSE Framework (ALTA 2024 / Wang et al. 2002, 2004, 2006)")
